[![Ensure compliance with Ledger guidelines](https://github.com/dhealthproject/app-dHealth/actions/workflows/guidelines_enforcer.yml/badge.svg)](https://github.com/dhealthproject/app-dHealth/actions/workflows/guidelines_enforcer.yml) [![Build and run functional tests using ragger through reusable workflow](https://github.com/dhealthproject/app-dHealth/actions/workflows/build_and_functional_tests.yml/badge.svg)](https://github.com/dhealthproject/app-dHealth/actions/workflows/build_and_functional_tests.yml)

# dHealth-ledger-app
DHP wallet application for Ledger devices.
...
* Open a terminal and clone `app-dHealth` with `git clone git@github.com:dhealthproject/app-dHealth.git`.
* Open the `app-dHealth` folder with VSCode.
...
The dHealth app comes with functional tests implemented with Ledger's [Ragger](https://github.com/LedgerHQ/ragger) test framework.
...
- Unit tests of C functions with [cmocka](https://cmocka.org/) (see [tests/unit-tests/](tests/unit-tests/))
- End-to-end tests with [Speculos](https://github.com/LedgerHQ/speculos) emulator and [ragger](https://github.com/LedgerHQ/ragger) (see [tests/functional](tests/functional))
